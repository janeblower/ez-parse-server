    ...
    actions: {
        ...
        get: {
            async handler(ctx) {
                ...
                const races = [];
                const racesName = ["Человек", "Дворф", "Найтэльф", "Гном", "Дреней", "Орк", "Нежить", "Таурен", "Тролль", "Бладэльф"];
                ...
                const classes = [];
                const classesName = ["Охотник", "Чернокнижник", "Жрец", "Паладин", "Маг", "Разбойник", "Друид", "Шаман", "Воин", "ДК"];
